...
function save()	{
	document.getElementById("SaveNews_bean_content").value=CKEDITOR.instances.editor.getData();
};

function deActivate(attachmentName)	{
	setBeanValue();
	document.getElementById("selectedFileAttachmentName").value=attachmentName;
	document.getElementById("SaveNews").action = "DeActivateAttachmentForSavedNews.action";
	document.getElementById("SaveNews").submit();
};
function activate(attachmentName)	{
	setBeanValue();
	document.getElementById("selectedFileAttachmentName").value=attachmentName;
	document.getElementById("SaveNews").action = "ActivateAttachmentForSavedNews.action";
	document.getElementById("SaveNews").submit();
};
...
function deleteAttachment(attachmentName)	{
	setBeanValue();
	document.getElementById("selectedFileAttachmentName").value=attachmentName;
	document.getElementById("SaveNews").action = "DeleteFileForSavedNews.action";
	document.getElementById("SaveNews").submit();
};
