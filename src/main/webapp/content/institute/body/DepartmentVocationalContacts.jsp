...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsVocationalContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра профессионального образования']}">
<a id="canceltp" href="DepartmentsVocationalContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsVocationalContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>