...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsSocioScientificContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра общественно-научных дисциплин']}">
<a id="canceltp" href="DepartmentsSocioScientificContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsSocioScientificContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>