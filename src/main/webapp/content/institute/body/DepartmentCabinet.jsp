...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsCabinetSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кабинет «ОБЖ и физического воспитания»']}">
<a id="canceltp" href="DepartmentsCabinet" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsCabinetSave_departmentBean_mainContent").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>