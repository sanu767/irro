...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsPhilologicalSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра филологического образования']}">
<a id="canceltp" href="DepartmentsPhilological" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsPhilologicalSave_departmentBean_mainContent").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>