...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsCabinetContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кабинет «ОБЖ и физического воспитания»']}">
<a id="canceltp" href="DepartmentsCabinetContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsCabinetContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>