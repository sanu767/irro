...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsCabinetMaterialsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кабинет «ОБЖ и физического воспитания»']}">
<a id="canceltp" href="DepartmentsCabinetMaterials" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsCabinetMaterialsSave_departmentBean_materials").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>