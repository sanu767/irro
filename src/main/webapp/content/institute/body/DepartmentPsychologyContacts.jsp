...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsPsychologyContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра педагогики и психологии']}">
<a id="canceltp" href="DepartmentsPsychologyContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsPsychologyContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>