...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsPhilosophyContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра философии и управления образованием']}">
<a id="canceltp" href="DepartmentsPhilosophyContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsPhilosophyContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>