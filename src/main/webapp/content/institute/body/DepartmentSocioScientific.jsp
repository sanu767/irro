...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsSocioScientificSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра общественно-научных дисциплин']}">
<a id="canceltp" href="DepartmentsSocioScientific" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsSocioScientificSave_departmentBean_mainContent").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>