...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsScienceContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра естественнонаучного и математического образования']}">
<a id="canceltp" href="DepartmentsScienceContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsScienceContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>