...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsChildrenContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра методологии и методики образования детей с ОВЗ и детей, оставшихся без попечения родителей']}">
<a id="canceltp" href="DepartmentsChildrenContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsChildrenContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>