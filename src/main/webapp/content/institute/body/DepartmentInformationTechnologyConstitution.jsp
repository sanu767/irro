...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsITConstitutionSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра информационных технологий']}">
<a id="canceltp" href="DepartmentsITConstitution" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsITConstitutionSave_departmentBean_constitution").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>