...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsChildrenSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра методологии и методики образования детей с ОВЗ и детей, оставшихся без попечения родителей']}">
<a id="canceltp" href="DepartmentsChildren" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsChildrenSave_departmentBean_mainContent").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>