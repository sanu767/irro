...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsHumanitiesContactsSave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра гуманитарного образования']}">
<a id="canceltp" href="DepartmentsHumanitiesContacts" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsHumanitiesContactsSave_departmentBean_contacts").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>