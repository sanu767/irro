...
<div id="savetp" >
<s:form cssStyle="width:1px;height: 1px;" action="DepartmentsPsychologySave" method="POST">
...
<s:if test="%{#session.permissionMap['Кафедра педагогики и психологии']}">
<a id="canceltp" href="DepartmentsPsychology" ><button class="btn btn-link" type="button" value="Cancel">Cancel</button></a>
</s:if>
...
<script>
	...
	function save()	{
		document.getElementById("DepartmentsPsychologySave_departmentBean_mainContent").value=CKEDITOR.instances.editor.getData();
	};
</script>
</body>
</html>