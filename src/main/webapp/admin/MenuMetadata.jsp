...
<div style="margin : 5px 0px 0px 10px">
	...
	<s:form action="CreateMenuMetadata" theme="xhtml" accept-charset="UTF-8">

		<sj:textfield name="menu" label="Menu " maxlength="50"
			required="true" placeholder="Enter title" />
			
		<sj:textfield name="parentMenu" label="Parent Menu " maxlength="100"
