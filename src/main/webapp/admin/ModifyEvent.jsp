...
function save()	{
	document.getElementById("ModifyEvent_bean_content").value=CKEDITOR.instances.editor.getData();
};

function deActivate(attachmentName)	{
	setBeanValue();
	document.getElementById("selectedFileAttachmentName").value=attachmentName;
	document.getElementById("ModifyEvent").action = "DeActivateEventAttachment.action";
	document.getElementById("ModifyEvent").submit();
};
function activate(attachmentName)	{
	setBeanValue();
	document.getElementById("selectedFileAttachmentName").value=attachmentName;
	document.getElementById("ModifyEvent").action = "ActivateEventAttachment.action";
	document.getElementById("ModifyEvent").submit();
};
...
function deleteAttachment(attachmentName)	{
	setBeanValue();
	document.getElementById("selectedFileAttachmentName").value=attachmentName;
	document.getElementById("ModifyEvent").action = "DeleteEventFile.action";
	document.getElementById("ModifyEvent").submit();
};
