...
<div style="margin : 5px 0px 0px 10px">
	<h1 style="font-size: 18px;font-family: 'Open Sans';">Rename Menu</h1>

	<s:form action="RenameMenu" theme="xhtml" accept-charset="UTF-8">
	<input type="hidden" id="selectedMenuId" name="selectedMenuId" value="<%=  selectedMenuId %>" />
	 
	 <sj:textfield name="menu" label="Enter New Name " maxlength="50"
			required="true" placeholder="Enter Menu Name" />

		<sj:submit button="Rename" value="Rename" />
