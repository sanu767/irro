...
<div style="padding-top:50px;">
 ...
 <s:if test="%{#session.userId == null}">
 	<a style="float:right;height:19px;padding-left:5px;" href="<%=request.getContextPath() %>/registerWL" >Register</a>
 ...
 <s:else>
	...
	<a style="float:right;height:19px;padding-left:5px;" href="<%=request.getContextPath() %>/modifyWL" >Edit your account</a>
 </s:else>
